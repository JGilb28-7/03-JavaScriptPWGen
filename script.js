...
let lowerCasedCharacters = ['a','s','d','f','g','h','j','k','l','q','w','r','t','y','p']
let upperCasedCharacters = ['A','S','D','F','G','H','J','K','L','Z','X','C','V','B','N','M']
let otherSpecialCharacters = ['+','=','[','}','|','<','>']
 

// Assignment Code
//let generateBtn = document.querySelector("#generate"); was on line 155 also commented out to test
...
function getPasswordOptions() {
  ...
  let hasotherSpecialCharacters = confirm(
    'this was added in as extra work to test code'
  );
